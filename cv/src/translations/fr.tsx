...
export const fr: Translations = {
  ...
  profile: {
    ...
    points: {
      ...
      wideRangeOfITSkills:
        'Large panel de compétences IT (web, devops, système, réseau)',
    },
  },
  skills: {
    heading: 'Compétences',
    programming: {
      label: 'Programmation',
      content:
        'Rust (Actix, Tauri), Typescript/Javascript (Express, Nest.js, Angular, React, Deno), HTMX, C/C++, Java (Spring Boot), Scala, Python, Android, PHP, Bash',
    },
    architecture: {
      label: 'Architecture',
      content:
        'Azure Cloud, AWS, Terraform, Docker avec Kubernetes, Ansible, Microservices, Serverless, REST, gRPC, GraphQL',
    },
    cicd: {
      label: 'CI/CD',
    ...
    security: {
      label: 'Security',
      content:
        "Audits complets d'applications, Cryptographie, Analyses de risques, OAuth2/OIDC/SAML",
    },
    languages: {
      label: 'Langages',
    ...
    companies: {
      vittascience: {
        ...
        tasks: {
          ...
          arduinoIDE:
            "Implémentation d'un IDE Arduino complet en version web pour les jeunes.",
      ...
      itnovem: {
        ...
        tasks: {
          ...
          aap:
            'Lead développeur sur une application IoT event-driven en Nest.js.',
          webapps:
            "En charge du développement et de l'architecture d'applications métier en Spring Boot/Angular.",
        },
      },
      sncf: {
        ...
        tasks: {
          teaching:
            'Formation de plusieurs promotions de développeurs juniors (Typescript, Spring Boot, sécurité du web).',
          communityManagement:
            'Management de la communauté de développeurs et conférencier en interne.',
          leadDevsCommittee: 'Membre du comité des lead développeurs.',
          aws:
            "Lead développeur sur des projets d'APIs serverless basées sur AWS avec Spring Cloud Function.",
          security:
            'Référent principal sur les architectures de sécurité préconisées dans les développements.',
        },
      },
    },
  },
  ...
  education: {
    ...
    esgi: (
      <>
        ...
        ({links.esgi.certificate('Certificat')})
      </>
    ),
  },
  links: {
    ...
    blaze: (
      <>
        Je suis l&apos;auteur de{' '}
        {links.blaze}, un système de build pour les monorepos écrit en Rust.
      </>
    ),
    github: <>Mon {links.github.current('profil Github')} actuel.</>,
    oldGithub: (
      <>Mon ancien {links.github.old('profil Github')} d&apos;étudiant.</>
    ),
  },
  aboutMe: {
