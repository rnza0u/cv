  ...
  esgi: {
    ...
    certificate: (label: string) =>
      ExternalLink({
        label,
        url:
          'https://certificate.bcdiploma.com/check/AAB3111E594F219797217E3A9304E6A26EAA0F97CCC05E96CF5CB941E608BE8AUWp3Nnl0YXU4QW16cmtuSGtmOG8xbGZ5b3BTUUZ4S0RFSTN4SWxsVkdiUVhJRkwr',
      }),
  },
  blaze: ExternalLink({
    label: 'Blaze',
